...
const ProfileSetUp = () => {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      // Show toast immediately after getting the download URL
      toast.success("Profile updated successfully");

      // Update the image state for rendering
    ...
    console.log("the description",desc)
  };
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="mt-5 flex flex-col w-[90%] md:w-[40%] lg:w-[30%] items-center align-middle p-6 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105 duration-300 ease-in-out">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <label className="cursor-pointer mb-4">
            <span className="text-blue-600 font-semibold hover:underline">Upload Profile Picture</span>
            <input
              type="file"
